...
(facts
  ...
  (facts
    ...
    (fact
      "1"
      (find-frequency [+1, -2, +3, +1]) => 3)

    (fact
      "2"
      (find-frequency [+1, +1, +1]) => 3)

    (fact
      "3"
      (find-frequency [+1, +1, -2]) => 0)

    (fact
      "4"
      (find-frequency [-1, -2, -3]) => -6))
  ...
  (facts
    ...
    (fact
      "1"
      (find-repeat-frequency [+1, -2, +3, +1]) => 2)

    (fact
      "2"
      (find-repeat-frequency [+1, -1]) => 0)

    (fact
      "3"
      (find-repeat-frequency [+3, +3, +4, -2, -4]) => 10)

    (fact
      "4"
      (find-repeat-frequency [-6, +3, +8, +5, -6]) => 5)

    (fact
      "5"
      (find-repeat-frequency [+7, +7, -2, -7, -4]) => 14))
